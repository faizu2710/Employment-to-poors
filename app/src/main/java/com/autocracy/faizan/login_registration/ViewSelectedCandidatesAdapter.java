...
public class ViewSelectedCandidatesAdapter extends RecyclerView.Adapter<ViewSelectedCandidatesAdapter.MyViewHolder> {


    Context context;
    ArrayList<SelectionData> arrayList;
    public String userid,experience;
    public ViewSelectedCandidatesAdapter(Context c, ArrayList<SelectionData> a){
        this.context = c;
        this.arrayList = a;
    ...
    @NonNull
    @Override
    public ViewSelectedCandidatesAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new ViewSelectedCandidatesAdapter.MyViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.selection_list,viewGroup,false));
    }

    @Override
    public void onBindViewHolder(@NonNull final ViewSelectedCandidatesAdapter.MyViewHolder myViewHolder, final int i) {
