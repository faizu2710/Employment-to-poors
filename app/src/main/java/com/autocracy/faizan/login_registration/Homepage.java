...
public class Homepage extends AppCompatActivity {
    ...
    CardView getjob, postjob, notification, scholarship, donation, profile, upload;
...
//                            Toast.makeText(JobRegistration.this, "User not Found", Toast.LENGTH_LONG).show();
        ...
        scholarship.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(Homepage.this,ScholarshipModule.class);
                startActivity(i);
            }
        });
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(Homepage.this,Uploader.class);
                startActivity(i);
                finish();
            }
        });
