...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.MyViewHolder> {
    ...
    private ArrayList<String> mBlogDesc = new ArrayList<>();
    ...
    public DataAdapter(Fetch activity, ArrayList<String> mBlogTitleList,ArrayList<String> mBlogDesc) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.tv_blog_title.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mActivity.startActivity(new Intent("android.intent.action.VIEW", Uri.parse(mBlogDesc.get(position))));
            }
        });
