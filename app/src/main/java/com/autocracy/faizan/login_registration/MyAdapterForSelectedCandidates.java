...
public class MyAdapterForSelectedCandidates extends RecyclerView.Adapter<MyAdapterForSelectedCandidates.MyViewHolder> {

    Context context;
    ArrayList<ListData> arrayList;
    public MyAdapterForSelectedCandidates(Context c, List<ListData> a){
        this.context = c;
        this.arrayList = (ArrayList<ListData>) a;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, int i) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                myViewHolder.appliedlabel.setText("Selected");
        ...
        myViewHolder.l.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context,ViewSelectedCandidates.class);
...
//        });
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        TextView title,location,count,datetime,tcount,appliedlabel;
...
//            deletepost = itemView.findViewById(R.id.deletepost);
            ...
            appliedlabel = itemView.findViewById(R.id.appliedlabel);
