...
public class HomepageCN extends AppCompatActivity {
    public AlertDialog dialog;
    private long backpressed;
    public DatabaseReference databaseReference;
    FirebaseDatabase firebaseDatabase;
    CardView postjob, donation,ngo;
    ...
    protected void onStart() {
        ...
        if (!haveNetwork())
        {
            new SweetAlertDialog(HomepageCN.this, SweetAlertDialog.WARNING_TYPE)
...
//            Toast.makeText(Homepage.this, "Internet connection not available", Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_homepage_cn);
        ...
        actionBarDrawerToggle = new ActionBarDrawerToggle(HomepageCN.this,drawerLayout,R.string.open,R.string.close);
...
//                                            .changeAlertType(SweetAlertDialog.SUCCESS_TYPE);
                                        ...
                                        Intent i = new Intent(HomepageCN.this, MainActivity.class);
                                        startActivity(i);
                                        finish();
...
//                                startActivity(new Intent(HomepageCN.this, HomepageCN.class));
//                                finish();
                            }
                        })
...
//        profile = findViewById(R.id.profile);
        ...
        donation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(HomepageCN.this,Donation.class);
                startActivity(i);
                finish();
            }
        });
        ...
        postjob.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                final android.app.AlertDialog dialog = new SpotsDialog.Builder().setContext(HomepageCN.this).setMessage("Loading").build();
                dialog.show();
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.hasChild(id)) {
                            ...
                            startActivity(new Intent(HomepageCN.this, ViewCompanyPosts.class));
                            dialog.dismiss();

                            finish();
                        } else {
//                            Toast.makeText(JobRegistration.this, "User not Found", Toast.LENGTH_LONG).show();
                            Intent i = new Intent(HomepageCN.this, companyRegistration.class);
                            startActivity(i);
                            dialog.dismiss();
...
//            @Override
//            public void onClick(View view) {
//                new SweetAlertDialog(Homepage.this)
